...
Core of the framework is very simple: you get two-layer menu system and routes encapsulated into classes. Here's fully working administrative view:
...
When you plug your administrative view into the *Admin* object, the new menu item will be created and Flask routes will be registered for you. You can define as many views as you want. All exposed routes will have */admin/* prefix added automatically.
 ...
 * Batteries (CRUD interface for different ORMs, file admin, redis console, etc) are built on top of core APIs and are completely optional.
...
Flask-Admin uses default Bootstrap skin for a simple reason: I did not want to make various assumptions for the developer how his UI should look like and didn't want to complicate his life when he'll decide to make his interface look differently.
