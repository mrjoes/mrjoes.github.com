...
This version has lots of bug fixes as well as some new functionality.
...
It is supports almost all features, except of many-to-many relationships.
...
[Click here to see sample](https://github.com/mrjoes/flask-admin/blob/master/examples/peewee/simple.py)
...
Here's how you can add your own action:
...
using `InlineFormAdmin` class instance:
...
You can use similar form configuration properties (form_columns, exclude_form_columns, form_args, etc)
to configure generated form.
